        ...
        <section className="py-10 md:pt-14 md:pb-20 relative">
          <div className="container mx-auto relative z-10">
            <div className="w-full md:w-1/2 mt-4 mb-8 mx-auto">
              <p>Maria Teresa Graell Bigatà, responsable del lloc web, d’ara endavant el RESPONSABLE, posa a disposició dels usuaris aquest document, amb el qual pretén fer complir les obligacions que estableix la Llei 34/2002, de 11 de juliol, de Serveis de la Societat de la Informació i de Comerç Electrònic (LSSICE), BOE N.º 166, així com informar tots els usuaris del lloc web sobre quines són les condicions d’ús.</p>
              ...
              <p>Maria Teresa Graell Bigatà es reserva el dret de modificar qualsevol tipus d’informació que pugui aparèixer al lloc web, sense l’obligació de preavisar o assabentar els usuaris d’aquestes obligacions, atès que es considera suficient la publicació al lloc web de Maria Teresa Graell Bigatà.</p>
              <h2>1. DADES IDENTIFICADORES</h2>
              <p>Nom del domini: www.clinicadentalgraell.com
              <br/>Nom comercial: Clínica Dental Graell
              <br/>Denominació social: Maria Teresa Graell Bigatà
              <br/>NIF: 52309048X
              <br/>Domicili social: C/ Bisbe Iglesias Navarri nº 15, baixos, local 4
              <br/>Telèfon: 973351860
              <br/>E-mail: contacte@clinicadentalgraell.com
              </p>
              <p className="font-bold">Activitat reglada</p>
              <p>Col·legi Professional: Col·legi Oficial d'Odontòlegs i Estomatòlegs de Catalunya (COEC)
              <br/>Núm. Col·legiat: 5967
              <br/>Títol acadèmic oficial: Títol universitari oficial de Llicenciada d’Odontologia
              <br/>Estat UE d’expedició: Espanya
              </p>
              ...
              <p>Els dissenys, logotips, text i/o gràfics aliens al RESPONSABLE i que puguin aparèixer al lloc web, pertanyen als seus respectius propietaris, els quals són responsables de qualsevol possible controvèrsia que se’n pugui desprendre. El RESPONSABLE autoritza expressament que tercers puguin redirigir directament als continguts concrets del lloc web, i en tot cas redirigir al lloc web principal de <a href="https://clinicadentalgraell.com" title="clinicadentalgraell.com">clinicadentalgraell.com</a>. </p>
              ...
              <p>Per a efectuar qualsevol tipus d’observació pel que fa a possibles incompliments dels drets de propietat intel·lectual o industrial, així com sobre qualsevol dels continguts del lloc web, podeu fer-ho a través del correu electrònic contacte@clinicadentalgraell.com.</p>
              <h2>3. EXEMPCIÓ DE RESPONSABILITATS</h2>
              <p>El RESPONSABLE s’eximeix de qualsevol tipus de responsabilitat derivada de la informació publicada al seu lloc web en cas que aquesta informació hagi estat manipulada o introduïda per un tercer aliè al RESPONSABLE.</p>
            </div>
          </div>
        </section>
      </main>
