...
const TeamSheet4 = () => {
  const colRef =
    EquipTexts.persones[3].numCol !== null ? (
  ...
  return (
    <>
      <Head>
        <title>
          {EquipTexts.persones[3].salutation} {EquipTexts.persones[3].name} -{" "}
          {GlobalTexts.brand}
        </title>
      </Head>
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-1/2 mt-4 mb-8 pl-32">
                <ul className="breadcrumb list-none flex items-center">
                  ...
                  <li>
                    <span>
                      {EquipTexts.persones[3].salutation}{" "}
                      {EquipTexts.persones[3].name}
                    </span>
                  </li>
                </ul>
                ...
                {colRef}
                <ul className="mt-10">
                  {EquipTexts.persones[3].description.map((el, idx) => (
                    <li key={idx}>{el}</li>
                  ))}
                </ul>
              </div>
