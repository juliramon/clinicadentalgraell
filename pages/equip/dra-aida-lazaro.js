...
const TeamSheet2 = () => {
  ...
  return (
    <>
      <Head>
        <title>
          {EquipTexts.persones[1].salutation} {EquipTexts.persones[1].name} -{" "}
          {GlobalTexts.brand}
        </title>
      </Head>
            ...
            <div className="flex flex-wrap">
              <div className="w-full md:w-1/4 lg:mt-4 mb-8">
                <div className="aspect-w-12 aspect-h-16 relative">
                  ...
                  <picture>
                    <img
                      src={EquipTexts.persones[1].image}
                      datasrc={EquipTexts.persones[1].image}
                      alt={EquipTexts.persones[1].name}
              ...
              <div className="w-full md:w-1/2 mt-4 mb-8 lg:pl-32">
                <ul className="breadcrumb list-none flex items-center">
                  ...
                  <li>
                    <span>
                      {EquipTexts.persones[1].salutation}{" "}
                      {EquipTexts.persones[1].name}
                    </span>
                  </li>
                </ul>
                ...
                <ul className="mt-10 pl-6 lg:pl-0">
                  {EquipTexts.persones[1].description.map((el, idx) => (
                    <li key={idx}>{el}</li>
                  ))}
                </ul>
              </div>
