...
const Footer = ({ GlobalTexts, HomeTexts }) => {
  ...
  return (
    <footer className="bg-primary-100 bg-opacity-20 pt-12 pb-8 lg:pt-24">
      <div className="container border-b border-primary-100 pb-12">
        <div className="flex flex-wrap flex-start justify-between md:-mx-5 lg:-mx-12">
          <div className="w-full md:w-1/2 lg:w-1/4 md:px-5 lg:px-12">
            <picture>
          ...
          <div className="w-full md:w-1/2 lg:w-1/4 md:px-5 lg:px-12 mt-6 lg:mt-0">
            <h3>Horari</h3>
